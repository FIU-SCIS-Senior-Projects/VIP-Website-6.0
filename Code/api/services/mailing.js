    ...
    User.findById(user_token.valueOf(), function (err, user) {
        ...
        if (user) {
           ...
           var object = {}
            ...
            var content = "Dear VIP user, you received this email in order to a password reset request. Please click on the link below, or copy and paste it into your web browser to proceed:" + "<br/>\n" + "<br/>\n " + baseWebUrl + "/password_request?auth_id=" + object.user_id + "&code=" + object.verifyCode
