(function () {
    ...
    function reviewStudentAppCtrl($window,$state, $scope, reviewStudentAppService, ToDoService,User, reviewPPS, ProjectService, ProfileService) {
		...
		function ApproveData(user)
		{
            ...
            // User Story #1144
			success_msg();
			var log = {projectid: user.projectid, student: user._id, firstName: user.firstName, lastName: user.lastName, studentemail: user.email, selectProject: user.project, gender: user.gender, department: user.department, college: user.college, action: "Approved", type: "student", skillItem: user.skillItem, appliedDate: user.appliedDate};
		...
		function RejectData(user)
		{
			...
			//User Story #1144
			var log = {projectid: user.projectid, student: user._id, firstName: user.firstName, lastName: user.lastName, studentemail: user.email, selectProject: name, gender: user.gender, department: user.department, college: user.college, action: "Rejected", type: "student", skillItem: user.skillItem, appliedDate: user.appliedDate};
			reviewPPS.createLog(log).then(function(success)  {
